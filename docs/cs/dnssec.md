...
Pokud registrujete doménu přímo přes Roští, administrace DNSSEC zapíná automaticky: vytvoří nebo použije DNS zónu, zapne DNSSEC v DNSAPI a předá DNSKEY údaje registrátorovi. Pokud ještě nejsou klíče připravené, registrace se neodešle a platba se nestrhne; zkuste registraci za chvíli zopakovat. U už registrovaných domén můžete synchronizaci DNSSEC spustit v detailu domény tlačítkem **Zapnout nebo synchronizovat DNSSEC**.
